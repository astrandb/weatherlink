...
async def get_coordinator(
    ...
    def _preprocess(indata: str):
        ...
        if entry.data[CONF_API_VERSION] == ApiVersion.API_V1:
            outdata[1] = {}
            outdata[1]["DID"] = indata["davis_current_observation"].get("DID")
            outdata[1]["station_name"] = indata["davis_current_observation"].get(
                "station_name"
            )
            outdata[1][DataKey.TEMP_OUT] = indata.get("temp_f")
            outdata[1][DataKey.TEMP_IN] = indata["davis_current_observation"].get(
                "temp_in_f"
            )
            outdata[1][DataKey.HUM_IN] = indata["davis_current_observation"].get(
                "relative_humidity_in"
            )
            outdata[1][DataKey.HUM_OUT] = indata.get("relative_humidity")
            outdata[1][DataKey.BAR_SEA_LEVEL] = indata.get("pressure_in")
            outdata[1][DataKey.WIND_MPH] = indata.get("wind_mph")
            outdata[1][DataKey.WIND_GUST_MPH] = indata["davis_current_observation"].get(
                "wind_ten_min_gust_mph"
            )
            outdata[1][DataKey.WIND_DIR] = indata.get("wind_degrees")
            outdata[1][DataKey.DEWPOINT] = indata.get("dewpoint_f")
            outdata[1][DataKey.RAIN_DAY] = indata["davis_current_observation"].get(
                "rain_day_in"
            )
            outdata[1][DataKey.RAIN_STORM] = indata["davis_current_observation"].get(
                "rain_storm_in"
            )
            outdata[1][DataKey.RAIN_RATE] = indata["davis_current_observation"].get(
                "rain_rate_in_per_hr"
            )
            outdata[1][DataKey.RAIN_MONTH] = indata["davis_current_observation"].get(
                "rain_month_in"
            )
            outdata[1][DataKey.RAIN_YEAR] = indata["davis_current_observation"].get(
                "rain_year_in"
            )
            outdata[1][DataKey.BAR_TREND] = indata["davis_current_observation"].get(
        ...
        if entry.data[CONF_API_VERSION] == ApiVersion.API_V2:
            ...
            for sensor in indata["sensors"]:
                ...
                if sensor["sensor_type"] == 55 and sensor["data_structure_type"] == 10:
                    outdata[tx_id][DataKey.DATA_STRUCTURE] = sensor[
                        "data_structure_type"
                    ]
                    outdata[tx_id][DataKey.TEMP_OUT] = sensor["data"][0]["temp"]
